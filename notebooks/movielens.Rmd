...
* The difference in ratings although significant in statistical terms is very small in  practical terms
...
meu_theta <- function(x, i) {
    ...
    prop1 <- y[y$xx_century == TRUE,]$n / total
    prop2 <- y[y$xx_century == FALSE,]$n / total
...
* There's indication of a significant difference at 95% of confidence, which indicates that movies from the XX century have a higher proportion of well rated movies in terms of inference as well.
